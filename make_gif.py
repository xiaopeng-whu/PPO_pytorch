...
def save_gif_images(env_name, has_continuous_action_space, max_ep_len, action_std):
    ...
    gif_images_dir = "PPO_gif_images_test" + '/'
    ...
    directory = "PPO_preTrained_test" + '/' + env_name + '/'
...
def save_gif(env_name):
    ...
    # input images
    gif_images_dir = "PPO_gif_images_test/" + env_name + '/*.jpg'
...
def list_gif_size(env_name):
    ...
    gif_dir = "PPO_gifs_test/" + env_name + '/*.gif'
